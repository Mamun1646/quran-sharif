...
const quran_schema_1 = require("./quran.schema");
let QuranService = class QuranService {
    constructor(quranModel) {
        this.quranModel = quranModel;
    }
    async findAll() {
        return await this.quranModel.find();
    }
    async versesFindBySurah(data) {
...
QuranService = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(quran_schema_1.Quran.name)),
